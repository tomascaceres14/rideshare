# RideShare Microservices project

## Project overview

A Uber‑style ride‑sharing app from the ground up—using Go, Docker, Kubernetes and Microservices architecture.
...
PROJECT_ID: ride-sharing-504614
```
...
```bash
gcloud container clusters get-credentials ride-sharing --region europe-west1 --project ride-sharing-504614
```
